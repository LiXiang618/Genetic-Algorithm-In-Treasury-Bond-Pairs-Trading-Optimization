...
ui <- shinyUI(fluidPage(
  ...
  tags$style(".well {background-color: #CCFFCC; }"),
  titlePanel(h1("Pairs", span("Trading and GA Optimization", style = "font-weight: 300"), 
                style = "font-family: 'Source Sans Pro';
                color: #fff; text-align: center;
                background-image: url('texturebg.png');
                padding: 20px"),
    windowTitle ="Pairs Trading and GA Optimization" ),
  
  navbarPage("Pairs Trading and GA Optimization",
    tabPanel('Cointegration Pairs Trading Model',
             sidebarPanel(
               ...
               actionButton("begin1_1", "Run Program",icon = icon("play")),
               tags$style(type='text/css', "#begin1_1 { width:80%; margin-left: 10%; margin-left: 10%;}")
             ),
    ...
    tabPanel('Genetic Algorithm Model',
             sidebarPanel(
               ...
               sliderInput("num2_9","Population Size",min = 5,max = 100,step = 1, value = 30),
               sliderInput("num2_10","Iteration",min = 1,max = 200,step = 1, value = 80),
               sliderInput("num2_11","Mutation Rate",min = 0,max = 1,step = 0.01, value = 0.2),
               sliderInput("num2_12","Crossover Rate",min = 0,max = 1,step = 0.01, value = 0.7),
               
               actionButton("begin2_1", "Run Program",icon = icon("play")),
               tags$style(type='text/css', "#begin2_1 { width:80%; margin-left: 10%; margin-left: 10%;}")
             ),
             mainPanel(
    ...
    tabPanel('Genetic Algorithm Simulation',
             sidebarPanel(
               ...
               actionButton("begin3_1", "Training Results",icon = icon("book")),
               tags$style(type='text/css', "#begin3_1 { width:80%; margin-left: 10%; margin-left: 10%;}"),
               ...
               actionButton("begin3_2", "Choose Training Set",icon = icon("pencil-square-o")),
               tags$style(type='text/css', "#begin3_2 { width:80%; margin-left: 10%; margin-left: 10%;}"),
               actionButton("begin3_3", "Run Program",icon = icon("play")),
               tags$style(type='text/css', "#begin3_3 { width:80%; margin-left: 10%; margin-left: 10%;}")
             ),
             mainPanel(
